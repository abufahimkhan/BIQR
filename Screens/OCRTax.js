...
export default function OCRTax() {
  ...
  const handleTextUpload = () => {
    // console.log('Edited Text:', editedText);
     const id_T = route.params.id_R; // Retrieve the docId from navigation params
    firestore()
      .collection('USERS')
      .doc(id_T) // Use the docId passed from the previous screen
      .update({Tax_Token_Info: editedText})
      .then(() => {
  ...
  const handleNextButton = () => {
    if (uploadDone) {
      navigation.navigate('login_user',{id_T:route.params.id_R});
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentInsetAdjustmentBehavior="automatic">
        <View style={styles.content}>
          <Text style={styles.title}>OCR TAX TOKEN</Text>
